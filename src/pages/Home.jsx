    ...
    <section className='flex items-center justify-center min-h-screen px-8 relative'>
      ...
      >
        ...
        >
          <Link
            to='/projects'
            className='bg-purple-600 hover:bg-purple-700 px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center gap-2'
          >
            <FaRocket /> See My Work
          </Link>
          <Link
            to='/contact'
            className='border border-purple-600 hover:bg-purple-800 px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105'
          >
            Let's Talk
          </Link>
        </motion.div>
